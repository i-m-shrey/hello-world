# ============================================================================
# FINAL PRODUCTION FILE (July 15 2026 — TZ stale-tick fix + entry gate).
# Fill the six <<<PASTE-...>>> placeholder lines: MT5_ACCOUNT / MT5_PASSWORD /
# MT5_SERVER / MT5_TERMINAL_PATH / TELEGRAM_TOKEN / TELEGRAM_CHAT_ID, save as
# live_mt5_bot.py. Credentials never travel through chat/git (house rule).
# ============================================================================
"""
================================================================================
...
MINLOT_SYMBOLS = ("XAUUSD", "SPX500", "GER40", "US30", "JPN225", "HK50")
...
def _usd_side(symbol, is_long):
    ...
    if symbol in ("SPX500", "GER40", "US30", "JPN225", "HK50"):
        return 0
    base_up_is_usd_down = symbol in ("EURUSD", "GBPUSD", "XAUUSD")
