...
def admin_trigger_execution():
    ...
    try:
        ...
        env['RUN_MODE'] = mode
        # Ensure average fall CSV path is consistent regardless of CWD
        env['AVG_FALL_CSV'] = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'strategy_runner', 'average_percentage_fall_indices.csv')
