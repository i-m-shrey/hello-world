...
def get_executor_for_broker(broker_name: str):
    ...
    if name == "FINVASIA":
        file_path = os.path.join(script_dir, "finvasia_executor.py")
        return _load_module_by_path("finvasia_executor", file_path)
        ...
        file_path = os.path.join(script_dir, "dhan_executor.py")
        return _load_module_by_path("dhan_executor", file_path)
    
    elif name == "ZERODHA":
        file_path = os.path.join(script_dir, "zerodha_executor.py")
        return _load_module_by_path("zerodha_executor", file_path)
    
    elif name == "UPSTOX":
        file_path = os.path.join(script_dir, "upstox_executor.py")
        return _load_module_by_path("upstox_executor", file_path)
    
    elif name == "GROWW":
        file_path = os.path.join(script_dir, "groww_executor.py")
        return _load_module_by_path("groww_executor", file_path)
