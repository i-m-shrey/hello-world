...
class SupportedBroker(db.Model):
    ...
    video_static_ip_url = db.Column(db.Text)  # How to whitelist static IP on this broker's portal
...
class Broker(db.Model):
    ...
    proxy_whitelisted = db.Column(db.Boolean, default=False, nullable=True)  # Client confirmed IP whitelisted on broker portal
